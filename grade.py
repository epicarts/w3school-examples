...
html_answers = ['Attributes', 'Basic', 'Block and inlines elements', 'CSS', 'Canvas Graphics', 'Classes', 'Comments', 'Computercode Elements', 'Form Elements', 'Forms', 'Geolocation', 'HTML Examples', 'Headings', 'IFrame',
